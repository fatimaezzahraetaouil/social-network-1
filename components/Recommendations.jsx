    ...
    <>
      {isLoading ? (
        <div className="min-h-screen flex justify-center items-center -my-8">
          <AiOutlineLoading3Quarters className="text-4xl text-rose-600 animate-spin text-center" />
        </div>
      ) : isError ? (
        ...
        <>
          <div className="grid md:grid-cols-2 gap-x-8 gap-y-4 mb-6">
            <div>
              <h1 className="text-rose-600 text-xl font-semibold mb-2">
                Popular Prblm Solvers
              </h1>
                  ...
                  <li key={developer.user._id} className="py-1.5">
                    <div className="flex items-center space-x-4">
                      ...
                      <Link href={`/${developer.user.username}`}>
                        <a className="inline-flex items-center shadow-sm px-2.5 py-0.5 border border-gray-300 text-sm leading-5 font-medium rounded-full text-gray-700 bg-white hover:bg-rose-600 hover:text-white transition">
                          View
                        </a>
                      </Link>
                    </div>
          ...
          <h1 className="text-rose-600 text-xl font-semibold mb-4">
