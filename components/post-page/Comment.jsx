      ...
      <div className="flex w-full items-start mb-4 md:w-5/6">
        ...
        <div className="ml-2 flex flex-col flex-1">
          <h4 className="font-semibold">
            <Link href={`/${comment.user.username}`}>
              <a className="hover:text-rose-600 transition">
          ...
          <div className="flex items-center space-x-2 text-gray-700 mt-1">
            ...
            {user && user._id === comment.user._id && (
              <TrashIcon
                ...
                className="h-4 w-4 cursor-pointer text-rose-600"
              />
            )}
          </div>
          {replyOpen && (
            <form onSubmit={postReply} className="relative mt-3 flex">
              <input
                className="border-2 rounded-l p-1.5 text-sm border-rose-600 w-full focus:outline-none"
              ...
              />
              <button className="bg-rose-600 rounded-r px-2 py-1  h-100">
