        ...
        <div className="flex justify-between mt-1 items-center px-1">
          ...
          <div className="flex items-center text-sm">
            <div className="flex items-center">
              <HeartIcon className="h-4 w-4 mr-1 text-gray-400 hover:text-rose-600 transition" />{' '}
              <p>{post.likes.length}</p>
            </div>
            <div className="flex items-center ml-3">
              <EyeIcon className="h-4 w-4 mr-1 text-gray-400 hover:text-rose-600 transition" />{' '}
              <p>{post.views}</p>
            </div>
          </div>
        </div>
