...
const features = [
  ...
  },
  {
    ...
    description:
      'A hall of fame for Prblm Solvers with most number of likes on their posts on weekly, monthly and all time basis.',
    icon: BiMedal,
  },
  {
  ...
  },
  {
    ...
    description:
      'New to the platform and not sure whom to follow? Let us help you out by suggesting some awesome Prblm Solvers.',
      ...
      <div className="container mx-auto pb-16 px-2 md:px-10 lg:px-12 sm:px-6 lg:pb-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-4 text-lg text-gray-500 px-2">
            Prblm Solvers is in its intial stages at the moment. You can expect the
