...
const Stats = ({ users, posts }) => {
  ...
  return (
    <div className="bg-rose-600 pt-12 sm:pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            href="https://www.producthunt.com/posts/Prblm Solvers?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-Prblm Solvers"
            target="_blank"
          >
            <img
              src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=314294&theme=light"
              alt="Prblm Solvers - Just like Welcome to Prblm Solvers | Product Hunt"
              width="250"
              height="54"
      ...
      <div className="mt-10 pb-12 bg-white sm:pb-16">
        <div className="relative">
          <div className="absolute inset-0 h-1/2 bg-rose-600" />
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <dl className="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-3">
                <div className="flex flex-col border-b border-gray-100 p-6 text-center sm:border-0 sm:border-r">
                  <dt className="order-2 mt-2 text-lg leading-6 font-medium text-gray-500">
                    Prblm Solvers Onboarded
                  </dt>
                  <dd className="order-1 text-5xl font-extrabold text-rose-600">
