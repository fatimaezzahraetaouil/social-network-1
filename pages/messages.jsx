        ...
        >
          {banner.name && banner.profilePicUrl ? (
            ...
            <div className="space-y-5">
              <div className="border border-rose-600 rounded-full inline-flex p-5 items-center justify-center">
                <ChatAltIcon className="h-20 w-20 text-rose-600" />
              </div>
              <div className="space-y-0.5">
                <h1 className="font-semibold text-xl">Chat with Prblm Solvers!</h1>
...
export async function getServerSideProps(ctx) {
  ...
  return {
    props: {
      ...
      title: 'Your Messages on Prblm Solvers',
    },
  };
}
