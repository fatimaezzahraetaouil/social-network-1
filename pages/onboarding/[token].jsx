        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-lg font-medium leading-6 text-rose-600">
            ...
            <form onSubmit={onSubmit}>
              <div className="shadow sm:rounded-md sm:overflow-hidden">
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  <div>
                    ...
                    <div className="mt-1 flex items-center">
                      ...
                      <label className="bg-gray-50 border-2 border-rose-600 ml-4 p-2 text-rose-600 font-medium rounded-md cursor-pointer text-sm shadow hover:bg-rose-100">
                        <input
                          type="file"
                      ...
                      <div className="mt-1 relative rounded-md shadow-sm col-span-6 sm:col-span-3">
                        <div className="flex rounded-md shadow-sm">
                          ...
                          <input
                            type="text"
                            name="github"
                            className="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md focus:ring-rose-500 focus:border-rose-500 sm:text-sm border-gray-300"
                ...
                <div className="px-4 py-3 bg-gray-50 text-right sm:px-6">
                  <button
                    type="submit"
                    className="inline-flex relative justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-rose-600 hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500 disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={loading}
                  >
                    Complete Onboarding
                    {loading && (
