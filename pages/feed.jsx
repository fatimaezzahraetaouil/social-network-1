...
const FeedPage = ({ user }) => {
  ...
  return (
    <>
      <div className="container mx-auto px-6 py-8 md:px-12 md:py-10">
        <h1 className="text-rose-600 text-2xl font-semibold mb-1">Your Feed</h1>
        <p className="text-gray-600 text-md mb-5">
          Recent posts from Prblm Solvers you follow
        </p>
        <InfiniteScroll
          hasMore={hasNextPage}
        ...
        {isFetchingNextPage && (
          <div className="py-8">
            <AiOutlineLoading3Quarters className="h-8 w-8 animate-spin mx-auto text-rose-600" />
          </div>
        )}
      </div>
    </>
...
export async function getServerSideProps(ctx) {
  ...
  return {
    props: {
      ...
      title: 'Your Feed on Prblm Solvers',
    },
  };
}
