    ...
    <div className="bg-gray-100 px-6 md:px-12 py-10">
      <div className="container mx-auto flex flex-col items-center">
        <h1 className="text-3xl mb-8 text-gray-700 font-bold mr-auto">
          Editing <span className="text-rose-600">{data?.title}</span>
        </h1>
        <form onSubmit={onSubmit} className="w-full">
          ...
          <div className="mb-5 mr-auto grid md:grid-cols-2 gap-4 w-full">
            ...
            <PostInput
              ...
              id="source-code"
              placeholder="https://github.com/itsnitinr/Prblm Solvers"
              value={sourceCode}
          ...
          <label
            htmlFor="description"
            className="block mr-auto text-md font-medium text-rose-600 mb-2"
          >
          ...
          <button
            type="submit"
            className="mt-8 flex items-center shadow w-full justify-center md:w-max ml-auto bg-rose-600 px-4 py-2 text-white font-semibold rounded-lg disabled:pointer-events-none disabled:opacity-50"
...
export async function getServerSideProps(ctx) {
  ...
  return {
    props: {
      ...
      title: 'Edit Post on Prblm Solvers',
    },
  };
}
